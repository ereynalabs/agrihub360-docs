...
- The How Do I pages are the exception: they show the real screen, a 540 wide JPEG of the app on the demo farm at phone size, in `images/screens/`. Cartoons explain, screenshots instruct. Never a real farm's records. A screenshot under `images/screens/` is drawn inside a phone bezel by `style.css`; nothing to add in the page.
